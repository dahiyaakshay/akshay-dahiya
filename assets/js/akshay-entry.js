(() => {
  ...
  var o = t.O(void 0, ["753", "825", "417", "577"], function () {
    return t(5724);
  });
  o = t.O(o);
})();
(function () {
  function i() {
    var e = document.querySelectorAll(".nav-menu-wrapper.tablet");
    if (e.length) {
      var t = new MutationObserver(function () {
        var e = document.querySelector(
          ".nav-menu-wrapper.tablet[data-nav-menu-open]",
        );
        document.body.classList.toggle("mobile-menu-locked", !!e);
      });
